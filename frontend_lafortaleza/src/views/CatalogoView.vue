    ...
    <header id="inicio" class="hero-section position-relative d-flex align-items-center justify-content-center">
      ...
      <div class="container hero-content text-center z-3">
        <div class="fade-in-up">
          <h1 class="display-1 brand-title text-gold mb-2 animate-glow">LA FORTALEZA</h1>
          <p class="h3 subtitle text-white mb-4">"Donde la confianza se celebra"</p>
          <div class="divider-gold mx-auto mb-4"></div>
          <p class="lead text-light max-width-600 mx-auto mb-5">
            La mejor selección de licores nacionales e importados para cada ocasión. Calidad garantizada en la fortaleza de tus celebraciones.
          </p>
          <div class="d-flex justify-content-center gap-3">
            <a href="#destacados" class="btn btn-gold-custom px-5 py-3 fw-bold">Comprar Ahora</a>
            <a href="#tienda" class="btn btn-outline-gold-large px-5 py-3 fw-bold">Ver Catálogo</a>
          </div>
        </div>
      </div>
    </header>
    ...
    <footer class="footer-premium border-top border-dark bg-dark-glow py-5">
      <div class="container">
        <div class="row g-5 mb-5">
          <div class="col-lg-4">
            <h4 class="brand-text-gold mb-4">LA FORTALEZA</h4>
        ...
        <div class="footer-bottom-gold text-center pt-4" style="border-top: 1px solid rgba(255,255,255,0.05);">
          <p class="text-secondary mb-0">&copy; 2026 LA FORTALEZA. Todos los derechos reservados. Diseñado para la materia SIS257.</p>
        </div>
      </div>
    </footer>
