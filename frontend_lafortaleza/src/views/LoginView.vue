  ...
  <div class="login-container">
    <div class="login-card">
      <div class="text-center mb-4">
        ...
        <h3 class="mt-2" style="color: var(--accent); font-weight: 800; letter-spacing: 1px;">LA FORTALEZA</h3>
      ...
      <div class="text-center mt-4 pt-3" style="border-top: 1px solid var(--border-color);">
        <small class="text-secondary"><i class="bi bi-shield-check"></i> SIS257 - Proyecto Académico</small>
      </div>
    </div>
  </div>
</template>
